        ...
        <section className={style.background}>
            <div className={style.privacyContainer}>
                ...
                <div>
                    ...
                    <ol>
                        <li>Niniejsza polityka dotyczy Serwisu www, funkcjonującego pod adresem url: <b>noviso.pl</b></li>
                        <li>Operatorem serwisu oraz Administratorem danych osobowych jest: NOVIL Sp. z o.o.</li>

                        <li>Adres kontaktowy poczty elektronicznej operatora: novil@novil.pl</li>
                    ...
                    <h2><strong className={style.font}>5. Logi Administratora</strong></h2>
                    <ol>
                    ...
                    <h2><strong className={style.font}>8. Zarządzanie plikami cookies – jak w praktyce wyrażać i cofać zgodę?</strong></h2>
                    <ol>
